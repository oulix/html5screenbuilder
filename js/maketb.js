...
+ '<input type"text" id"cols" placeholder"列"  value"3"  hidden /> ' + "\n"
+ '<script type"text/javascript" > ' + "\n"
...
+ '     ' + "\n"
+ ' ' + "\n"
 + ' <div id="editSet" style="padding:0; margin:0; align:center;" ondblclick="var elem = FindElementFromPoint(window.event.clientX,window.event.clientY); overlay() ; console.log(elem.id) "></div>' + "\n"
+ ' ' + "\n"
+ ' ' + "\n"
 + '<div id"overlay"  > ' + "\n"
